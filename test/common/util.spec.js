...
describe('global.js', function() {
   ...
   describe('#bindAll', function() {
      it('should return the object being bound', function() {
         ...
         expect(util.bindAll({}, o)).toEqual(o);
      });

      it('should set `this` for all methods', function() {
         var a = {};
         var o = {
            foo: function() { expect(this).toEqual(a); },
            bar: function() { expect(this).toEqual(a); }
         };
         util.bindAll(a, o);
         o.foo.call();
         o.bar.call();
      ...
      it('should not affect anything but functions', function() {
         ...
         var o = {
            foo: function() { expect(this).toEqual(a); },
            bar: function() { expect(this).not.toEqual(a); },
            omega: list
         };
         util.bindAll({}, o);
         expect(o.omega).toEqual(list);
      });
   });
